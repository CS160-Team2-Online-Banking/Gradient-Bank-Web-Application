...
class InternalAccount(AccountProcess):
    def __init__(self, data=None):
        ...
        def account_lookup(self, account_id_to_lookup, decrypted_auth_token):
            ...
            elif len(requesting_user_id) and len(this_accounts_id) and len(account_id_to_lookup) and requesters_type == "bank_manager":
